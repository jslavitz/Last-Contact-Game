...
var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'lastcontact', { preload: preload, create: create, update: update, render: render });

function preload() {

    game.load.image('backdrop', 'remember-me.jpg');
    game.load.image('card', 'titan_mech.png');
